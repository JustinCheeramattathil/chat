...
import 'package:chatos_messenger/features/call/repository/call_repository.dart';
...
class CallController {
  ...
  void makeCall(BuildContext context, String receiverName, String receiverUid,
   ...
   void makeAudioCall(BuildContext context, String receiverName, String receiverUid,
      String receiverProfilePic, bool isGroupChat) {
    ref.read(userDataAuthProvider).whenData((value) {
      String callId = const Uuid().v1();
      Call senderCallData = Call(
